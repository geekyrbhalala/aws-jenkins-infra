...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i C:\\Users\\Jigna\\Documents\\KeyPair\\ec2-universal-key.pem ubuntu@", aws_instance.jenkins_ec2_instance_ip.public_ip)
}
